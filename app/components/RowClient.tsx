      ...
      {selectedMovie && (
        ...
        >
          <button
            ...
            className="absolute top-4 right-4 md:top-8 md:right-8 z-[60] text-white hover:text-gray-300 transition-colors bg-black/50 hover:bg-black/70 rounded-full p-2 backdrop-blur-sm"
            aria-label="Close"
          >
